...
// Load constants first to get production credentials
if (!defined('DB_HOST')) {
    $constants_path = dirname(__DIR__) . '/helpers/constants.php';
    if (file_exists($constants_path)) {
        require_once $constants_path;
    } else {
        die('FATAL ERROR: Database configuration file not found. Please ensure helpers/constants.php exists.');
    }
}
// dipindah di helpers/contstants.php man untuk DB nya
// Verify all required constants are defined
if (!defined('DB_HOST') || !defined('DB_USER') || !defined('DB_NAME')) {
    die('FATAL ERROR: Database credentials not properly defined in helpers/constants.php');
}
