 ...
 * Fungsi-fungsi umum untuk sistem
 */

// Base URL
if (!defined('BASE_URL')) {
    define('BASE_URL', 'http://localhost/mbg');
}
...
if (!function_exists('log_activity')) {
    /**
     * Log activity user (wrapper for new db functions)
     */
    function log_activity($activity, $module = null, $reference_id = null) {
        ...
        return db_insert('log_activity', $data);
    }
}
