...
// Function untuk check active menu based on URL path keyword
...
<nav id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu-item">
            <a href="#masterSubmenu" data-bs-toggle="collapse" class="collapsed <?= is_active('/master/') ? 'active' : '' ?>">
                <i class="fas fa-database"></i>
                <span>Master Data</span>
            </a>
            <div class="collapse <?= is_active('/master/') ? 'show' : '' ?>" id="masterSubmenu">
        ...
        <!-- Request (Semua role) -->
        <div class="menu-item">
            <a href="<?= BASE_URL ?>/modules/request/index.php" class="<?= is_active('/request/') ?>">
        ...
        <!-- Laporan (Admin) -->
        <div class="menu-item">
            <a href="#laporanSubmenu" data-bs-toggle="collapse" class="collapsed <?= is_active('/laporan/') ? 'active' : '' ?>">
                <i class="fas fa-chart-line"></i>
                <span>Laporan</span>
            </a>
            <div class="collapse <?= is_active('/laporan/') ? 'show' : '' ?>" id="laporanSubmenu">
                <ul class="list-unstyled ps-4">
